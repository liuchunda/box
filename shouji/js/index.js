...
var loadingRender = (function () {
    var ary = ["icon.png", "zf_concatAddress.png", "zf_concatPhone.png", "zf_course.png", "zf_course1.png", "zf_course2.png", "zf_course3.png", "zf_course4.png", "zf_course5.png", "zf_course6.png", "zf_cubeBg.jpg", "zf_cubeTip.png", "zf_messageArrow1.png", "zf_messageArrow2.png", "zf_messageChat.png", "zf_messageKeyboard.png", "zf_messageLogo.png", "zf_messageStudent.png", "zf_outline.png", "zf_phoneBg.jpg", "zf_phoneDetail.png", "zf_phoneListen.png", "zf_phoneLogo.png", "zf_return.png", "zf_style1.jpg", "zf_style2.jpg", "zf_style3.jpg", "zf_styleTip1.png", "zf_styleTip2.png"];
...
var messageRender = (function () {
    ...
    function messageMove() {
        autoTimer = window.setInterval(function () {
            ...
            //->从第四条开始,没法送一条消息，都需要让整个消息区域往上移动相关的距离
            if (step >= 3) {
